...
* **📊 控制台与全动态真实步进条**：
  ...
  * **近期紧要待办**：聚合所有逾期及未来 7 天日程，默认折叠为一行摘要，鼠标触及时展开最紧急的 3 项，支持固定展开及继续查看其余待办。
...
* **✏️ 档案与求职环节自由修正**：
  ...
  * 支持将前后收到的两封邮件设为**同轮并列环节**（如「在线笔试｜综合测评」），两条记录各自保留独立的完成状态、截止时间、链接与备注。
* **🎨 双主题与交互微震动**：
...
左侧“招聘会”提供独立活动页面，可新增招聘会、双选会、宣讲会，记录主办方、起止时间、地点、链接及备注。
